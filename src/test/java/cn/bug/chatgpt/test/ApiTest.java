...
public class ApiTest {
    ...
    public void test_chat_completions_stream_channel() throws JsonProcessingException, InterruptedException {
        ...
        String apiKey = "sk-mnpYAt10gxYQctiQF5F7A48f8cB64c6d97F1F1Aa82834fB7";
...
//        log.info("测试结果：{}", imageResponse02);
    ...
    public void test_editImages() throws IOException {
        ImageResponse imageResponse = openAiSession.editImages(new File("F:\\Web\\Java\\chatgpt\\chatgpt-sdk\\docs\\images\\docs_images_996.png"), "去除图片中的文字");
